...
extern const u8 gText_PSS_DexNumberSpa[];
extern const u8 gText_PSS_Name[];
extern const u8 gText_PSS_NameSpa[];
extern const u8 gText_PSS_Status[];
extern const u8 gText_PSS_StatusSpa[];
extern const u8 gText_PSS_Type[];
extern const u8 gText_PSS_TypeSpa[];
extern const u8 gText_PSS_OT[];
extern const u8 gText_PSS_OTSpa[];
extern const u8 gText_PSS_IDNumber[];
extern const u8 gText_PSS_IDNumberSpa[];
extern const u8 gText_PSS_Item[];
extern const u8 gText_PSS_ItemSpa[];
extern const u8 gText_PSS_TrainerMemo[];
extern const u8 gText_PSS_TrainerMemoSpa[];
extern const u8 gText_PSS_HP[];
extern const u8 gText_PSS_HPSpa[];
extern const u8 gText_PSS_Attack[];
extern const u8 gText_PSS_AttackSpa[];
extern const u8 gText_PSS_Defense[];
extern const u8 gText_PSS_DefenseSpa[];
extern const u8 gText_PSS_SpAtk[];
extern const u8 gText_PSS_SpAtkSpa[];
extern const u8 gText_PSS_SpDef[];
extern const u8 gText_PSS_SpDefSpa[];
extern const u8 gText_PSS_Speed[];
extern const u8 gText_PSS_SpeedSpa[];
extern const u8 gText_PSS_ExpPoints[];
extern const u8 gText_PSS_ExpPointsSpa[];
extern const u8 gText_PSS_ToNextLv[];
extern const u8 gText_PSS_ToNextLvSpa[];
extern const u8 gText_PSS_Ability[];
extern const u8 gText_PSS_AbilitySpa[];
extern const u8 gText_PSS_Category[];
extern const u8 gText_PSS_CategorySpa[];
extern const u8 gText_PSS_Power[];
extern const u8 gText_PSS_PowerSpa[];
